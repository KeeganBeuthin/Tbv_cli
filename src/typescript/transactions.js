...
var Transactions = /** @class */ (function () {
    ...
    Transactions.main = function () {
        return __awaiter(this, void 0, void 0, function () {
            var args, amountCredit, amountDebit, httpResponse, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log("Executing TypeScript tests...");
                        args = process.argv.slice(2);
                        amountCredit = parseInt(args[0], 10) || 100;
                        amountDebit = parseInt(args[1], 10) || 50;
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, Transactions.httpRequest("https://jsonplaceholder.typicode.com/posts", "GET", "")];
                    case 2:
    ...
    Transactions.executeCreditLeg = function (amount) {
        console.log("Credit leg executed with amount: " + amount);
    };
    Transactions.executeDebitLeg = function (amount) {
